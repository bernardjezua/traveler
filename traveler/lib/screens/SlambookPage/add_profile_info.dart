...
import '../SignInPage/signup_page.dart';
  ...
  void submitForm() {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      setState(() {
        ...
        context.read<UserProfileProvider>().addSlambook(uid!, slambookInfo);
                ...
                Column(
                  children: [
                    ...
                    const Padding(
                      ...
                      child: Center(
                        child: Text(
                          "Enter your name, nickname, age, civil status, and other important information to be part of the Traveler Records.",
