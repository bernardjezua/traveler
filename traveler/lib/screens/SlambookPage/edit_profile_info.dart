...
class _EditProfileInfoState extends State<EditProfileInfo> {
  ...
  void initState() {
    super.initState();
    // Fetch the user data from the arguments passed
    WidgetsBinding.instance.addPostFrameCallback((_) { // Wait for the context to be fully built
      final arguments = ModalRoute.of(context)!.settings.arguments as Map<String, dynamic>; // Assuming arguments is a map
      //print(arguments);
      setState(() {
        // Set the initial values of the form fields
        nameController.text = arguments["slambook"]["name"];
        nicknameController.text = arguments["slambook"]["nickname"];
        ageController.text = arguments["slambook"]["age"];
        isSingle = arguments["slambook"]["isSingle"];
        happinessLevel = arguments["slambook"]["happinessLevel"];
        dropdownValue = arguments["slambook"]["vision"];
        selectedMotto = arguments["slambook"]["motto"];

        // Store previous values
        prevNickname = arguments["slambook"]["nickname"];
        prevAge = arguments["slambook"]["age"];
        prevIsSingle = arguments["slambook"]["isSingle"];
        prevHappinessLevel = arguments["slambook"]["happinessLevel"];
        prevVision = arguments["slambook"]["vision"];
        prevMotto = arguments["slambook"]["motto"];
      });
    });
  }
  ...
  void editForm() {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      setState(() {
        ...
        // Create a map of the slambook information
        Map<String, dynamic> slambookInfo = {
          "name": submittedName,
        ...
        String? uid = context.read<UserAuthProvider>().getUserId();

        // Add the slambook to the user's profile
        context.read<UserProfileProvider>().editSlambook(uid!, slambookInfo);
              ...
              children: <Widget>[
                ...
                Column(
                  children: [
                    ...
                    const Center(
                      child: Text(
                        "Edit Your Slambook Information!",
                        style: TextStyle(
                    ...
                    const Padding(
                      ...
                      child: Center(
                        child: Text(
                          "Enter your slambook information that you would like to be edited.",
